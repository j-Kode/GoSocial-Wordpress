...
**hashtagger 3.3 introduces cashtags and allows to remove symbols from links** ([Read more](http://smartware.cc/blog/2015/12/22/hashtagger-intoduces-cashtags-and-more-changes/))
...
**Translators welcome!** Please use [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/hashtagger) to translate.
...
6. hashtagger Settings Display Section: Option to not display symbols in front of generated links in Front End
7. hashtagger Settings Regenerate Section: Regenerate all existing Objects with the current settings
