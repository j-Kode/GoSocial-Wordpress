...
Plugin URI: http://smartware.cc/free-wordpress-plugins/hashtagger/
...
class Hashtagger {
  ...
  function add_text_domains() {  
    load_plugin_textdomain( 'hashtagger', false, plugin_basename( dirname( __FILE__ ) ) . '/languages' ); 
  }
  ...
  private function make_link( $match, $mktag ) {
    ...
    if ( !$tag ) {
      ...
      $content = $match[1] . '<a' . $css . ' href="' . get_tag_link($tag->term_id) . '">' . $symbol . $match[2] . '</a>';
    }
    return $content;
  }
...
class Hashtagger_Admin {
  ...
  function admin_page() {
    ...
    if ( ! in_array( $current_tab, array('general', 'advanced', 'posttype', 'sectiontype', 'css', 'display', 'regenerate') ) ) {
      $current_tab = 'general';
    }
    ?>
    <div class="wrap">
      <?php screen_icon(); ?>
      <h2 style="min-height: 32px; line-height: 32px; padding-left: 40px; background-image: url(<?php echo plugins_url( 'pluginicon.png', __FILE__ ); ?>); background-repeat: no-repeat; background-position: left center"><a href="http://smartware.cc/free-wordpress-plugins/hashtagger/">hashtagger</a> Settings</h2>
      <hr />
                ...
                <form method="post" action="options.php" class="hashtagger_settings_form">
                  ...
                  <?php if ( 'general' == $current_tab ) { ?>
                    <div class="postbox">
                      <div class="inside">
                        <?php
                          settings_fields( 'hashtagger_settings_general_cashtags' );   
                          do_settings_sections( 'hashtagger_settings_section_general_cashtags' );
                          submit_button(); 
                        ?>
                      </div>
                    </div>
  ...
  function admin_init() {
    ...
    add_settings_section( 'hashtagger-settings-general-cashtags', '', array( $this, 'admin_section_general_cashtag_title' ), 'hashtagger_settings_section_general_cashtags' );
    register_setting( 'hashtagger_settings_general_cashtags', 'swcc_htg_cashtags' ) ;
    add_settings_field( 'swcc_htg_settings_cashtags', __( '$cashtags', 'hashtagger' ) . ' <a class="dashicons dashicons-editor-help" href="http://smartware.cc/docs/hashtagger/#settings_general_cashtags"></a>', array( $this, 'admin_cashtags' ), 'hashtagger_settings_section_general_cashtags', 'hashtagger-settings-general-cashtags', array( 'label_for' => 'swcc_htg_cashtags' ) );
  ...
  // echo title for general settings section
  function admin_section_general_cashtag_title() {
    ...
    <div id="postbox-container-1" class="postbox-container">
      <div class="meta-box-sortables">
        <div class="postbox">
          ...
          <div class="inside">
            <ul>
              <li><div class="dashicons dashicons-wordpress"></div>&nbsp;&nbsp;<a href="http://wordpress.org/extend/plugins/hashtagger/"><?php _e( 'Please rate the plugin', 'hashtagger' ); ?></a></li>
              <li><div class="dashicons dashicons-admin-home"></div>&nbsp;&nbsp;<a href="http://smartware.cc/wp-hashtagger/"><?php _e( 'Plugin homepage', 'hashtagger'); ?></a></li>
              <li><div class="dashicons dashicons-admin-home"></div>&nbsp;&nbsp;<a href="http://smartware.cc/"><?php _e( 'Author homepage', 'hashtagger' );?></a></li>
              <li><div class="dashicons dashicons-googleplus"></div>&nbsp;&nbsp;<a href="https://plus.google.com/+SmartwareCc"><?php _e( 'Authors Google+ Page', 'hashtagger' ); ?></a></li>
              <li><div class="dashicons dashicons-facebook-alt"></div>&nbsp;&nbsp;<a href="https://www.facebook.com/smartware.cc"><?php _e( 'Authors facebook Page', 'hashtagger' ); ?></a></li>
            </ul>
          </div>
        </div>
        <div class="postbox">
          ...
          <div class="inside">
            <ul>
              ...
              <li><div class="dashicons dashicons-wordpress"></div>&nbsp;&nbsp;<a href="http://wordpress.org/plugins/hashtagger/faq/"><?php _e( 'Take a look at the FAQ section', 'hashtagger' ); ?></a></li>
              <li><div class="dashicons dashicons-wordpress"></div>&nbsp;&nbsp;<a href="http://wordpress.org/support/plugin/hashtagger"><?php _e( 'Take a look at the Support section', 'hashtagger'); ?></a></li>
              <li><div class="dashicons dashicons-admin-comments"></div>&nbsp;&nbsp;<a href="http://smartware.cc/contact/"><?php _e( 'Feel free to contact the Author', 'hashtagger' ); ?></a></li>
            </ul>
          </div>
        </div>
      </div>
