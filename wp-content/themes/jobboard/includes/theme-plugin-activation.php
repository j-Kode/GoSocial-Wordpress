...
/*        array(
        ...
        array(
        	'name'				=> 'Wolf Twitter',
        	'slug'				=> 'wolf-twitter',
        	'source'			=> 'http://plugins.wpwolf.com/wolf-twitter/wolf-twitter.zip',
        	'external_url'		=> 'http://wpwolf.com/plugin/wolf-twitter/',
        ),
    ...
    $config = array(
        ...
        'strings'      => array(
            'page_title'                      => __( 'Install Recommended Plugins', 'jobboard' ),
            ...
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'jobboard' ), // %s = dashboard link.
