...
class wpdb {
	...
	var $tables = array( 'posts', 'comments', 'links', 'options', 'postmeta',
		'terms', 'term_taxonomy', 'term_relationships', 'commentmeta', 'countries', 'states', 'cities', 'SocialMediaPostings', 'IndustryType',
        'socialMediaType','pricingType', 'messages', 'socialMediaAccounts','transactionHistory', 'balances', 'inProgressCampaigns', 'allowHire');
	...
	public $SocialMediaPostings;
	public $IndustryType;
	public $pricingType;
	public $socialMediaType;
    public $messages;
    public $socialMediaAccounts;
	public $inProgressCampaigns;
	public $allowHire;
	/**
